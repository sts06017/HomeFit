package kr.rabbito.homefit.utils.design
...
class GridSpacingItemDecoration(private val spanCount: Int,
    ...
    override fun getItemOffsets(
        ...
        if (includeEdge) {
            outRect.left = horizontalSpacing - column * horizontalSpacing / spanCount // spacing - column * ((1f / spanCount) * horizontalSpacing)
